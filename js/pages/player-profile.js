      ...
      <div class="settings-section">
        ...
        ${!recentMatches.length?'<div class="text-muted text-sm">No completed matches yet.</div>':
          recentMatches.slice(0,5).map(m=>`
            <a href="#/match/${m.id}" class="card card-clickable card-body" style="display:flex;justify-content:space-between;align-items:center;margin-bottom:8px">
              <div><div style="font-weight:600;font-size:13px">${m.team1Name} vs ${m.team2Name}</div>
